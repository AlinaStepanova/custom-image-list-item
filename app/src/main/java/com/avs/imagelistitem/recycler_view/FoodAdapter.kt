...
class FoodAdapter(private val clickListener: ItemListener, private val context: Context) :
    ListAdapter<UIData, FoodAdapter.ItemViewHolder>(ItemDiffCallback()) {
    ...
    class ItemViewHolder private constructor(private val binding: ListItemFoodBinding) :
        ...
        fun bind(
            ...
            binding.ivPoster.shapeAppearanceModel = binding.ivPoster.shapeAppearanceModel
                .toBuilder()
                .setAllCorners(CornerFamily.CUT, CORNER_SIZE)
                .build()
            binding.vBackgroundColor.shapeAppearanceModel =
                binding.vBackgroundColor.shapeAppearanceModel
                    .toBuilder()
                    .setBottomLeftCorner(CornerFamily.CUT, CORNER_SIZE)
                    .setBottomRightCorner(CornerFamily.CUT, CORNER_SIZE)
                    .build()
            Picasso.get()
                .load(item.url)
